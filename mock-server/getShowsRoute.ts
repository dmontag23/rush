...
const getRushAndLotteryShowsLondon200Response: TodayTixAPIRes<TodayTixShow[]> =
  {
    code: 200,
    data: [
      {
      ...
      },
      {
        ...
        images: {
          productMedia: {
            ...
            entryTitle:
              "Tina - The Tina Turner Musical [4] - LON Product Media",
            appHeroImage: {
              file: {
...
const getRushAndLotteryShowsNewYork200Response: TodayTixAPIRes<TodayTixShow[]> =
  {
    code: 200,
    data: [
      {
